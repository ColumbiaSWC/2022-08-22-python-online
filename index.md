...
humandate: "Aug 22-23, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2022-08-23        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Rob Lane (Unix)", "Alan Crosswell (Python day 1)", "Satwinder Singh (Git)", "Aaron Tran (Python day 2)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tameek Henderson", "Aaron Tran", "Alan Crosswell", "Moacir P de Sa Pereira", "Axinia Radeva", "Esther Jackson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
